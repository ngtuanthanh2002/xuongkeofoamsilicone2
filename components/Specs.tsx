      ...
      <div className="container-page">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-base text-slate-600 sm:text-lg">
            Thông số kỹ thuật keo bọt nở AM2 — đọc rõ, dễ tra cứu.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 max-w-xl">
          {products.map((p) => (
            <div
              key={p.id}
              className="overflow-hidden rounded-3xl shadow-card ring-1 ring-slate-200"
            >
              <div className="relative bg-gradient-to-b from-slate-900 to-brand-900 px-6 pt-6 text-center">
